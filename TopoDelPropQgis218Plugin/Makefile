...
# translation
SOURCES = propiedad.py ui_propiedad.py __init__.py propiedaddialog.py
#TRANSLATIONS = i18n/propiedad_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = propiedad

PY_FILES = propiedad.py propiedaddialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_propiedad.py
