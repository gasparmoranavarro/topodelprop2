...
"""
    ...
    @version: 0.1
    @summary: No se utiliza en el plugin
"""
...
import qgis.core
import qgis.gui
import UPV-DelProp.utilsPropiedad.utils
import UPV-DelProp.Atributos 
import pyUPVBib.pyGenGas
import pyUPVBib.utilidadesQgs
...
class ctrGuardaImg(QtGui.QDialog):
    #constructor
    def __init__(self, iface,vPpal):
        ...
        self.vPpal=vPpal
        self.iface=iface
        self.UtilidadesQgs=pyUPVBib.utilidadesQgs.UtilidadesQgs(self.iface)
        ...
        oTr=UPV-DelProp.utilsPropiedad.utils.DirTrabajos()
        self.numTrabajo=22 
        rut=oTr.sacaDir()
