...
# translation
SOURCES = pyupvbib.py ui_pyupvbib.py __init__.py pyupvbibdialog.py
#TRANSLATIONS = i18n/pyupvbib_en.ts
TRANSLATIONS = 
...
PY_FILES = pyupvbib.py pyupvbibdialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_pyupvbib.py
