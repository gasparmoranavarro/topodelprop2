...
#        file, ext = os.path.splitext(nombreImg)
        ...
        try:
            ...
            e.message="No se ha podido escribir la imagen " + imgSalida + ". Es posible que no tenga permiso de escritura en el directorio. No deben haber ni acentos, ni enyes en la ruta"
            return e
